...
* **desktop:** better fir for cn/kr packet capture ([5c9a824](https://github.com/ffxiv-teamcraft/ffxiv-teamcraft/commit/5c9a824))
* **search:** fixed search filters not being applied at all ([dfa621c](https://github.com/ffxiv-teamcraft/ffxiv-teamcraft/commit/dfa621c))
...
* **db:** fixed 6.05 tomestone mats not listed as trades ([465f07e](https://github.com/ffxiv-teamcraft/ffxiv-teamcraft/commit/465f07e))
...
* **desktop:** hotfix for retainer inventories not tracked properly ([5894743](https://github.com/ffxiv-teamcraft/ffxiv-teamcraft/commit/5894743))
...
* **db:** fixed wrong scrips being referenced in trades and collectables ([aa71dc4](https://github.com/ffxiv-teamcraft/ffxiv-teamcraft/commit/aa71dc4))
* **layout:** fixed ability to craft not being computed properly ([3ce9f0c](https://github.com/ffxiv-teamcraft/ffxiv-teamcraft/commit/3ce9f0c))
* **lists:** fixed recipe ingredients not being added properly ([88d975b](https://github.com/ffxiv-teamcraft/ffxiv-teamcraft/commit/88d975b))
* **simulator:** fixed progression being doubled and other small flooring inaccuracies ([a7e1fa9](https://github.com/ffxiv-teamcraft/ffxiv-teamcraft/commit/a7e1fa9))
...
* **currency-spending:** removed unusable currencies ([6721de3](https://github.com/ffxiv-teamcraft/ffxiv-teamcraft/commit/6721de3))
...
* **data:** added missing data for 5.3 nodes and items ([6f94344](https://github.com/ffxiv-teamcraft/ffxiv-teamcraft/commit/6f94344))
* **desktop:** fix for endless firewall rule creation popup ([90b4730](https://github.com/ffxiv-teamcraft/ffxiv-teamcraft/commit/90b4730))
* **list:** fixed an issue with some skybuilders materials breaking panels ([2960247](https://github.com/ffxiv-teamcraft/ffxiv-teamcraft/commit/2960247))
* **metrics:** fixed dashboard only opening once ([78725cb](https://github.com/ffxiv-teamcraft/ffxiv-teamcraft/commit/78725cb))
* **simulator:** added missing foods ([48c4d90](https://github.com/ffxiv-teamcraft/ffxiv-teamcraft/commit/48c4d90))
...
* **chinese-mb:** fixed pricing autofill, **requires you to link your character again** ([d76ca06](https://github.com/ffxiv-teamcraft/ffxiv-teamcraft/commit/d76ca06))
* **desktop:** fixed log autofill not filling in some cases ([49c9872](https://github.com/ffxiv-teamcraft/ffxiv-teamcraft/commit/49c9872))
* **pricing:** fixed missing icon in marketboard fill buttons ([cbfc70a](https://github.com/ffxiv-teamcraft/ffxiv-teamcraft/commit/cbfc70a))
...
* **universalis:** remove GST because it was screwed with profit calcs ([255c115](https://github.com/ffxiv-teamcraft/ffxiv-teamcraft/commit/255c115))
