export const stats = [
  ...
  {
    "id": 51,
    "en": "Desynthesis Skill Gain",
    "de": "Verbessertes Verwertungsgeschick",
    "ja": "分解スキル上昇率",
    "fr": "Augmentation de la compétence de recyclage",
    "filterName": "DesynthesisSkillGain"
  },
  {
    "id": 52,
    "en": "EXP Bonus",
