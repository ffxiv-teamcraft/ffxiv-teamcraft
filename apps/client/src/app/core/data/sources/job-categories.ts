export const jobCategories = {
  ...
  '60': {
    'en': 'GLA MRD LNC PLD WAR DRG DRK GNB',
    'ja': '剣術士 斧術士 槍術士 ナイト 戦士 竜騎士 暗黒騎士 ガンブレイカー',
    'de': 'GLA MAR PIK PLD KRG DRG DKR REV',
    'fr': 'GLA MRD HAS PLD GUE DRG CHN PSB'
  },
  '61': {
  ...
  '86': {
    'en': 'PLD WAR DRK GNB MNK DRG NIN SAM',
    'ja': 'ナイト 戦士 暗黒騎士 ガンブレイカー モンク 竜騎士 忍者 侍',
    'de': 'PLD KRG SMA REV MÖN DRG NIN',
    'fr': 'PLD GUE CHN PSB MOI DRG NIN SAM'
  },
  '87': {
    'en': 'BRD MCH DNC BLM SMN RDM WHM SCH AST',
    'ja': '吟遊詩人 機工士 踊り子 黒魔道士 召喚士 赤魔道士 白魔道士 学者 占星術師',
    'de': 'BRD MCH TÄN SMA BES RMA WMA GLT AST ',
    'fr': 'BRD MCH DNS MNO INV MRG MBL ÉRU AST'
  },
  '88': {
