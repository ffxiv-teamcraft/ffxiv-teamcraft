...
export const DATA_REPORTERS: Provider[] = [
  ...
  { provide: DataReporters, useClass: FishingReporter, multi: true, deps: [EorzeaFacade, LazyDataFacade, EorzeanTimeService, IpcService, SettingsService, FishTrainFacade] },
