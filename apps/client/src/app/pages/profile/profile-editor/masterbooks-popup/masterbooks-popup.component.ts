...
export class MasterbooksPopupComponent implements OnInit {
  ...
  private static BOOKS: { [index: number]: number[] } = {
    ...
    //BSM
    9: [8136, 7779, 9337, 12245, 14127, 17870, 22310, 24267, 7787, 29485],
    //ARM
    10: [8137, 7780, 9338, 12246, 14128, 17871, 22311, 24268, 7788, 29486],
    //GSM
    11: [8138, 7781, 9339, 12247, 14129, 17872, 22312, 24269, 7789, 29487],
    //LTW
    12: [8139, 7782, 9340, 12248, 14130, 17873, 22313, 24270, 7790, 29488],
    //WVR
    13: [8140, 7783, 9341, 12249, 14131, 17874, 22314, 24271, 7791, 29489],
    //ALC
    14: [8141, 7784, 9342, 12250, 14132, 17875, 22315, 24272, 7792, 29490],
    //CUL
