...
export class MasterbooksPopupComponent implements OnInit {
  ...
  private static BOOKS: { [index: number]: number[] } = {
    ...
    //BSM
    9: [8136, 7779, 9337, 12245, 14127, 17870, 22310],
    //ARM
    10: [8137, 7780, 9338, 12246, 14128, 17871, 22311],
    //GSM
    11: [8138, 7781, 9339, 12247, 14129, 17872, 22312],
    //LTW
    12: [8139, 7782, 9340, 12248, 14130, 17873, 22313],
    //WVR
    13: [8140, 7783, 9341, 12249, 14131, 17874, 22314],
    //ALC
    14: [8141, 7784, 9342, 12250, 14132, 17875, 22315],
    //CUL
    15: [7785, 9343, 12251, 14133, 17876, 22316],
    //MIN
    16: [12238, 12239, 12240, 17838, 17839],
    //BTN
    17: [12698, 12699, 12700, 17840, 17841],
    //FSH
    18: [12701, 12702, 12703, 17842, 17843]
  };
