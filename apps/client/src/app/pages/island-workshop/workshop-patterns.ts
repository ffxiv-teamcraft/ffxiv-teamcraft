...
export const workshopPatterns: WorkshopPattern[] = [
  ...
  [[2, -1], [1, 2], [2, 3], [2, 1], [1, 1], [1, 1], [2, 4]], // Cycle 6 weak
  [[2, -1], [1, 2], [2, 4], [2, 0], [1, 0], [0, 0], [2, 4]], // Cycle 6 Strong

  [[2, -1], [1, 2], [2, 4], [2, 1], [2, 1], [1, 1], [1, 1]], // Cycle 7 weak
  [[2, -1], [1, 2], [2, 4], [2, 2], [2, 0], [1, 0], [0, 0]], // Cycle 7 Strong
];
