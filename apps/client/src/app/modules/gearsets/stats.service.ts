...
export class StatsService {
  ...
  private static LEVEL_TABLE: number[][] = [
    ...
    [360, 388, 3300, 2400, 569, 569],
    [365, 390, 3300, 2500, 569, 569],
    [370, 392, 3300, 2600, 569, 569],
    [375, 394, 3300, 2700, 569, 569],
    [380, 396, 3300, 2800, 569, 569],
    [385, 398, 3300, 2900, 569, 569],
    [390, 400, 3300, 3000, 569, 569]
  ];
