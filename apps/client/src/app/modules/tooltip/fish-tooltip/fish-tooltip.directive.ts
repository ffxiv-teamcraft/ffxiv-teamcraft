...
import { FishTooltipComponent } from './fish-tooltip.component';
 ...
 */
@Directive({
  selector: '[appFishTooltip]'
})
export class FishTooltipDirective implements OnDestroy {
  ...
  show() {
    ...
    this._subscription = this._tooltipData.getItemTooltipData(this.fishId).subscribe(this._createTooltip);
  }
