...
import {LazyGatheringBonuse} from './model/lazy-gathering-bonuse';
...
import {LazyItemSetBonuse} from './model/lazy-item-set-bonuse';
...
import {LazyStatuse} from './model/lazy-statuse';
...
export interface LazyData {
  ...
  collectablesShops: Record<number, object>;
  ...
  craftingLog: Array<object>;
  desynth: Record<number, object>;
  diademTerritory: Record<number, LazyDiademTerritory>;
  dropSources: Record<number, object>;
  ...
  fateSources: Record<number, object>;
  ...
  gatheringBonuses: Record<number, LazyGatheringBonuse>;
  ...
  instanceSources: Record<number, object>;
  ...
  itemSetBonuses: Record<number, LazyItemSetBonuse>;
  ...
  lootSources: Record<number, object>;
  ...
  reduction: Record<number, object>;
  ...
  statuses: Record<number, LazyStatuse>;
  ...
  usedInQuests: Record<number, object>;
  ventureSources: Record<number, object>;
  ...
  koGatheringBonuses: Record<number, LazyKoGatheringBonuse>;
  ...
  zhGatheringBonuses: Record<number, LazyZhGatheringBonuse>;
