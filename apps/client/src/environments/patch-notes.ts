...
* **core:** fixed extracts file staying in cache and not clearing properly.
* **currency-spending:** page now works properly.
* **desktop:** fix for firewall rule not created properly.
* **desktop:** fixed firewall rules management for packet capture.
* **desktop:** fixed google oauth.
