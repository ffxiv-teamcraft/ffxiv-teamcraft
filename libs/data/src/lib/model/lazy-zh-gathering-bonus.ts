...
export enum Zh {
  ...
  灵巧大于等于ValueIntegerParameter1Value = "灵巧 大于等于<Value>IntegerParameter(1)</Value>",
  获得力大于等于ValueIntegerParameter1Value = "获得力 大于等于<Value>IntegerParameter(1)</Value>",
  ...
  连锁大于等于ValueIntegerParameter1Value = "连锁 大于等于<Value>IntegerParameter(1)</Value>",
  采集力上限大于等于ValueIntegerParameter1Value = "采集力上限 大于等于<Value>IntegerParameter(1)</Value>",
  ...
  鉴别力大于等于ValueIntegerParameter1Value = "鉴别力 大于等于<Value>IntegerParameter(1)</Value>",
